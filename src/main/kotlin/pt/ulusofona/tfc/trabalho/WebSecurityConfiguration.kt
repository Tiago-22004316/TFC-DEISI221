...
//            .antMatchers("/**").permitAll()
    ...
    override fun configure(auth: AuthenticationManagerBuilder) {
        auth.inMemoryAuthentication()
                ...
                .and()
                .withUser("tmorais").password(passwordEncoder().encode("trabjus")).roles("USER")
                .and()
                .withUser("pbarros").password(passwordEncoder().encode("trabjus")).roles("USER")
                .and()
                .withUser("djesus").password(passwordEncoder().encode("trabjus")).roles("USER")
                .and()
