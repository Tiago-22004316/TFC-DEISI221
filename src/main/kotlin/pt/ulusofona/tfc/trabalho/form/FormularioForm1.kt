...
data class FormularioForm1(
        ...
        //secção 1
        @field:NotEmpty(message = "Erro: O número do processo tem de ser preenchido")
        @field:Size(max = 50, message = "Erro: O número de processo não pode ter mais do que 50 caracteres")
        var processId: String = "",

        @field:NotEmpty(message = "Erro: A comarca tem de ser preenchida")
        var comarca : String = "",

        @field:NotEmpty(message = "Erro: O juizo tem de ser preenchido")
        var juizo : String = "",
